...
//------------------------------------------------------------------------------
//
_CopyPaste::_CopyPaste(bool pEnable, QString pProgram, QString pParameters,
                       QString pWorkingDirectory, int pTimeOut, bool pStop,
                       bool pLog)
{
   setEnable(pEnable);
   setProgram(pProgram);
...
// =============================================================================
//
_QTableWidgetScript::_QTableWidgetScript(QWidget *pParent) :
